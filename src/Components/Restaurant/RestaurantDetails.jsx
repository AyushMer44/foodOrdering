...
const RestaurantDetails = () => {
    ...
    // console.log("Menu Items outside",menu.menuItems)
    // console.log("Ingredients Items outside",ingredients.ingredientsItems)

    useEffect(() => {
        dispatch(getRestaurantById({jwt,restaurantId:id}))
        dispatch(getRestaurantsCategory({jwt,restaurantId:id}))
        
        // dispatch(getIngredientsOfRestaurant({jwt,restaurantId:id}))
    },[])
            ...
            <section>
                ...
                <div>
                    <Grid container spacing={2}>
                        ...
                        <Grid item xs={12} lg={6}>
                            <img className='w-full h-[40vh] object-cover'
                                 src="https://cdn.pixabay.com/photo/2015/11/26/22/28/woman-1064664_640.jpg" alt=""/>
                        </Grid>
                    </Grid>
                </div>
